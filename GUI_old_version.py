...
st.markdown("<div style='text-align: center; font-size: 20px; color: red;'>Please click <a href='https://www.li-lab-cat-design.com/'>here</a> to access our new site</div>", unsafe_allow_html=True)
