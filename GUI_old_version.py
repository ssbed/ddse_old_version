...
st.markdown("<div style='text-align: center; font-size: 20px; color: red;'>finger_ion; <a href='https://www.li-lab-cat-design.com/'>Please click here to access our new site</a></div>", unsafe_allow_html=True)
